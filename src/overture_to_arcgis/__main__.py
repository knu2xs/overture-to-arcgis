...
logger = get_logger(logger_name="overture_to_arcgis", level="INFO")
...
def example_function(in_path: Union[str, Path]) -> pd.DataFrame:
    ...
    ``` python
    from overture_to_arcgis import example_function
...
class ExampleObject(object):
    ...
    def example_static_function(in_path: Union[str, Path]) -> pd.DataFrame:
        ...
        ``` python
        from overture_to_arcgis import ExampleObject
    ...
    def example_class_method(cls) -> "ExampleObject":
        ...
        ``` python
        from from overture_to_arcgis import ExampleObject
